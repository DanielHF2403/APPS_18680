...
class MainActivity : Activity(), AdapterView.OnItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.bnCambio.setOnClickListener {
            ...
            alerta
                .setTitle("Atención")
                .setMessage("Quiere enviar el mensaje $textoSeleccionado")
                .setCancelable(false)
    ...
    override fun onItemSelected(vistaPadre: AdapterView<*>?, vistaRow: View?, position: Int, isVista: Long) {
        textoSeleccionado =
            vistaPadre?.getItemAtPosition(position).toString()
